                        ...
                        <div class="w-100 w-lg-75 w-xxl-50">
                            <div>
                                ...
                                <p class="h6 text-white lh-1-5 mb-5">
                                    "Welcome to our exciting online world. Please login and have a different experience
                                    with us!"
                                </p>
                ...
                <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
                    <div
                        ...
                        <div class="sw-lg-50 px-5">
                            <div class="sh-8">
                                <a href="<?= base_url() ?>">
                                    <img src="<?= base_url('assets/img/favicon/favicon.png') ?>" style="width:40px"
                                        alt="">
                                    <h2 style="display: inline;">SwiftDash</h2>
                                </a>
                            </div>
                            <div class="mb-5">
                            ...
                            <div>
                                <form id="registerForm" class="tooltip-end-bottom"
                                    action="<?= base_url('auth/registration') ?>" method="post" novalidate>
